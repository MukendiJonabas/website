...
export default function Digipublic() {
  return (
    ...
    <div className="mx-auto flex flex-col items-centermax-w-7xl px-5 pt-5 lg:flex-row">
      <div className="mb-16 flex flex-col text-left lg:mb-0 lg:w-1/2 lg:flex-grow lg:items-start lg:pr-16 lg:pr-6">
        ...
        <p>
          Nous aidons les administrations à améliorer leur efficacité, leur
          transparence et leur sécurité grace à des technologies de pointe.{" "}
        </p>
      </div>
